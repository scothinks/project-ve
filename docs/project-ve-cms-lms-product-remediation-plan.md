...
The addendum also governs controlled temporary entitlement grants and organisation AI metering. Temporary higher-plan access, granular temporary privileges, AI trials and AI top-ups must use the central entitlement/grant mechanism defined there, and organisation AI access must not be enabled until the addendum's required AI metering, budget and abuse-control ticket is implemented and accepted.
