...
export type AdminAdsCommandResult = {
  returnPath: string;
  notice: string;
};
...
export async function saveAdPlacementFallbackCommand(
  { supabase }: AdminContext,
  formData: FormData,
): Promise<AdminAdsCommandResult> {
  ...
  return {
    returnPath: "/admin/ads/inventory",
    notice: "Placement fallback campaign updated.",
  };
}

export async function saveAdPartnerCommand(
  ...
  return {
    returnPath: "/admin/ads/launch",
    notice: "Ad partner saved.",
  };
}

export async function saveAdCampaignCommand(
  { supabase }: AdminContext,
  formData: FormData,
): Promise<AdminAdsCommandResult> {
...
export async function saveAdCreativeVersionCommand(
  ...
  const imageAssetId = await uploadCreativeImage(context, formData, campaign.partner_id, input.imageAlt);
  ...
  return {
    returnPath: "/admin/ads/launch",
    notice: "Creative version saved.",
  };
}

export async function saveAdFlightCommand(
  { supabase }: AdminContext,
  formData: FormData,
): Promise<AdminAdsCommandResult> {
  ...
  return {
    returnPath: "/admin/ads/launch",
    notice: "Ad flight saved.",
  };
}

export async function setAdEntityStatusCommand(
  { supabase }: AdminContext,
  formData: FormData,
): Promise<AdminAdsCommandResult> {
...
export async function refreshAdBillingSnapshotCommand(
  { supabase }: AdminContext,
  formData: FormData,
): Promise<AdminAdsCommandResult> {
  ...
  return {
    returnPath: "/admin/ads/reporting",
    notice: "Billing snapshot refreshed.",
  };
}

export async function createAdMakeGoodRecommendationsCommand({
  supabase,
}: AdminContext): Promise<AdminAdsCommandResult> {
  ...
  return {
    returnPath: "/admin/ads/reporting",
    notice: "Make-good recommendations refreshed.",
  };
}

export async function purgeOldAdRuntimeDataCommand({
  supabase,
}: AdminContext): Promise<AdminAdsCommandResult> {
  ...
  return {
    returnPath: "/admin/ads/reporting",
    notice: "Ad retention cleanup completed.",
  };
}
