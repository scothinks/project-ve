  ...
  return (
    <section className="space-y-6">
      ...
      <AdminCard>
        <details>
          <summary className="cursor-pointer list-none">
            <p className="text-xs font-black uppercase tracking-[0.16em] text-[var(--ui-text)]">FAQ</p>
          ...
          <form action={saveStaticContentPage} className="mt-5 space-y-5">
            ...
            <div className="space-y-4">
              {faqItems.map((item, index) => (
                <div className="rounded-[18px] border border-[var(--ui-border-subtle)] bg-[var(--ui-chrome)] p-4" key={`faq-item-${index}`}>
      ...
      <AdminCard>
        <details>
          <summary className="cursor-pointer list-none">
            <p className="text-xs font-black uppercase tracking-[0.16em] text-[var(--ui-text)]">Terms</p>
      ...
      <AdminCard>
        <details>
          <summary className="cursor-pointer list-none">
            <p className="text-xs font-black uppercase tracking-[0.16em] text-[var(--ui-text)]">Privacy</p>
