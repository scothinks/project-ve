...
export default function MediaImage(props: ImageProps) {
  ...
  if (managed && failedSrc === props.src) return <span role="img" aria-label="Media unavailable" className="flex h-full min-h-16 items-center justify-center bg-neutral-100 p-3 text-sm text-neutral-600">Media unavailable</span>;
