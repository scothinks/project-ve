  ...
  return (
    <div className="mx-auto flex w-full max-w-[960px] flex-col gap-10">
      <div>
        ...
        <h1 className="text-[36px] font-black leading-[1.1] tracking-[-0.02em] text-[var(--ui-text)]">
      ...
      <div className="grid gap-5 lg:grid-cols-3">
        <div
          className="flex flex-col gap-4 rounded-[22px] border-[1.5px] border-[var(--ui-border-subtle)] bg-[var(--ui-surface)] p-7 text-left shadow-[0_2px_8px_rgba(var(--ui-shadow-rgb),0.04)] transition hover:border-[var(--ui-action)]"
        >
          <span
          ...
          <div>
            <h2 className="mb-1.5 text-[17px] font-extrabold text-[var(--ui-text)]">{availability.enabled ? <Link href="/admin/courses/ai/brief" className="underline underline-offset-4">Create with AI</Link> : 'Create with AI'}</h2>
            <p className="text-[13px] font-medium leading-[1.5] text-[var(--ui-text-muted)]">
        ...
        >
          <span className="flex h-12 w-12 items-center justify-center rounded-[14px] bg-[var(--ui-surface-soft)]">
            <svg aria-hidden="true" className="h-[22px] w-[22px]" fill="none" stroke="var(--ui-action)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" viewBox="0 0 24 24">
              <path d="M12 20h9" />
              <path d="M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4Z" />
            </svg>
          </span>
          <div>
            <h2 className="mb-1.5 text-[17px] font-extrabold text-[var(--ui-text)]">Start from scratch</h2>
            <p className="text-[13px] font-medium leading-[1.5] text-[var(--ui-text-muted)]">
        ...
        >
          <span className="flex h-12 w-12 items-center justify-center rounded-[14px] bg-[var(--ui-surface-soft)]">
            <svg aria-hidden="true" className="h-[22px] w-[22px]" fill="none" stroke="var(--ui-warning)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" viewBox="0 0 24 24">
          ...
          <div>
            <h2 className="mb-1.5 text-[17px] font-extrabold text-[var(--ui-text)]">Remix a course</h2>
            <p className="text-[13px] font-medium leading-[1.5] text-[var(--ui-text-muted)]">
