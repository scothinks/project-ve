  ...
  return (
    <PublicInfoShell title="Support">
      <div className="lg:text-center">
        <p className="text-xs font-bold uppercase tracking-[0.16em] text-[var(--ui-reward)]">Support</p>
        <h1 className="mt-2 text-3xl font-black leading-9 lg:text-4xl">Get help.</h1>
        <p className="mt-2 max-w-[90%] text-sm font-semibold leading-6 text-[var(--ui-text-muted)] lg:mx-auto lg:max-w-lg">
